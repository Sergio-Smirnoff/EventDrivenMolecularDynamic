...
def plot_presion_vs_L(L_values, P_means_A, P_means_B):
    ...
    plt.title("Presión promedio vs Longitud L")
    plt.grid(True)
    plt.legend()
    plt.show()
...
def presion_vs_area(files):
    ...
    plt.ylabel("Presión promedio [Pa]")
    plt.title("Presión promedio vs 1/Área")
    plt.grid()
    plt.legend()
    plt.show()
...
def ajuste_presion_vs_area(A_inv, P_means):
    ...
    plt.xlabel("1/Área [1/m²]")
    plt.ylabel("Presión promedio [Pa]")
    plt.title("Ajuste de Presión promedio vs 1/Área")
    plt.grid()
    plt.legend()
    plt.show()
...
def difusion(filename):
    ...
    plt.xlabel("Tiempo [s]")
    plt.ylabel("MSD [m²]")
    plt.title("Desplazamiento cuadrático medio (MSD)")
    plt.legend()
    plt.grid()
    plt.show()
